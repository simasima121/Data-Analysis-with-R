...
We are now exploring contribution amounts wrapped by gender. 
...
We are now exploring contribution amounts wrapped by Party's. 
...
```{r echo=FALSE, Contributions to Party's}
qplot(x = amount, data = subset(mdata, amount >= 0)) +
  scale_x_continuous(limits = c(0, 200), breaks = seq(0,200,20)) +
