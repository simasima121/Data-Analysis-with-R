...
# The second command, dim(mtcars), gives us the dimesions of an object
# and should output '[1] 32 11' to the console. The [1] indicates that
# 32 is the first value in the output.
